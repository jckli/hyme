...
func OnVoiceStateUpdate(session *discordgo.Session, event *discordgo.VoiceStateUpdate, b *Bot) {
...
func OnVoiceServerUpdate(session *discordgo.Session, event *discordgo.VoiceServerUpdate, b *Bot) {
